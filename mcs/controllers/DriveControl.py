...
def run(globals):
    ...
    if enabled:
        ...
        if tFlags.leftEncoder_enabled:
            thread_leftenc = threading.Thread(target = leftEncoder.run, args = (leftEncoder, globals, ))
        ...
        if tFlags.leftEncoder_enabled:
            thread_rightenc = threading.Thread(target = rightEncoder.run, args = (rightEncoder, globals, ))
